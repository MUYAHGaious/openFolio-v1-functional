            ...
            <div class="row z-depth-3">
                ...
                <div class="bg-light col-sm-8 rounded-right">
                    ...
                    <div class="row my-5">
                        ...
                        <div class="col-md-6">
                            <a href="" class="text-white  p-4 bgpurple-lighter rounded hover:bgpurple" style="text-decoration:
                                none">Share</a>
                        </div>
                        <div class="col-md-6">
                            <a href="profile/" class=" text-white p-4 bgpurple-lighter rounded hover:bgpurple"
