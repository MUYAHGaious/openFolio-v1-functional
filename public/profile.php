            ...
            <div class="row z-depth-3">
                <div class="bg-light col-sm-4  rounded-left">
                    <div class="card-block text-center text-black">
                        ...
                        <div class="container">
                            <img class="img rounded-circle img-fluid" src="<?php echo $Image; ?>"
                                onerror="this.src='projectUploads/defualt.png'" alt=""
                                style="width: 200px; height: 200px;; margin-top: 20px">

                            <div class="container col-md-12 mt-2  card p-5 bg-light">
                                <!--added the bootstap style "card" to the profile and index pages -->
                                <div class="row d-flex justify-content-center">
                                    <div class=" mt-2 pt-5">
                                        <div class="row z-depth-3">
                                            <div class="bg-light col-sm-4  rounded-left">
                                                ...
                                                <h2 class="font-weight-bold mt-4"><?php echo $row['username'] ?? ""?>
                                                </h2>
                                                <p><?php echo $row['first_name'] ?? ""?></p>
                                                <p><?php echo $row['last_name'] ?? ""?></p>
                                                <i class="far fa-edit fa-2x mb-4"></i>
                                        ...
                                        <div class="bg-light col-sm-8 rounded-right">
                                            ...
                                            <div class="row my-5">
                                                <div class="col-sm-6">
                                                    <button
                                                        class="text-white text-white p-4 bgpurple-lighter rounded hover:bgpurple">Share</button>
                                                </div>
                                                <div class="col-sm-6">
                                                    <a href="profile/"
                                                        class="text-white p-4 bgpurple-lighter rounded hover:bgpurple mb-2"
