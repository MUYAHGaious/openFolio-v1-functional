    ...
    <div class="container my-5 bg-lightpurple justify-content-center col-md-6 offset-md-3 shadow-md mt-5 p-5 rounded-5">
        <div class="container">
            ...
            <form action="add_project.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="tech_used" class="form-control" id="floatingName" placeholder="description"
                        required>
                    <label for="floatingName">technologies used</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="link" class="form-control" id="floatingName" placeholder="description"
                        required>
